...
<div class="product">
    ...
    <div class="product-image">
		<a href="<?php echo esc_url( $product->get_permalink() ); ?>"><img src="<?php echo esc_url( polo_theme_thumb( $thumb, '380', '507') ); ?>" alt="<?php echo esc_attr( get_the_title() ); ?>">
		</a>
	</div>
	...
	<div class="product-description">
		...
		<div class="product-title">
			<h3>
				<a href="<?php echo esc_url( get_the_permalink( get_the_ID() ) ); ?>"><?php echo esc_attr( get_the_title() ); ?></a>
			</h3>
		</div>
