...
foreach ( $images as $i => $image ) {
	...
	switch ( $onclick ) {
		...
		case 'link_image':
			$link_start = '<a class="zoom" data-lightbox="gallery-item" href="' . $large_img_src . '">';
			$link_end = '</a>';
			break;
...
$output .= '<div data-lightbox-type="gallery" class="wpb_gallery_slides' . $type . '" data-interval="' . $interval . '"' . $flex_fx . '>' . $slides_wrap_start . $gal_images . $slides_wrap_end . '</div>';
$output .= '</div>';
$output .= '</div>';
