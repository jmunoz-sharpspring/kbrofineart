...
$logo_text = polo_do_multilang_text($logo_text);
if ( is_singular( 'portfolio' ) ) {
...
$meta_description = polo_do_multilang_text($meta_description);
...
$output .= '<header id="header" class="header-no-sticky header-dark header-side-panel">';
