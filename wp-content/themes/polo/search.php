...
<section class="content <?php echo esc_attr( $section_class ); ?>">
	...
	<div class="container">
		...
		<?php else : ?>
            <h2 class="page-title"><?php esc_html_e( 'Nothing Found', 'polo' ); ?></h2>
		<?php endif;
		...
		endwhile;
            ...
            <p><?php esc_html_e( 'Sorry, but nothing matched your search terms. Please try again with some different keywords.', 'polo' ); ?></p>
			<?php
			get_search_form();
        } ?>
