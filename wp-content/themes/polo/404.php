...
$page_404_title = polo_do_multilang_text(reactor_option('page_404_title'));
$page_404_description = polo_do_multilang_text(reactor_option('page_404_description'));
...
<!-- 404 PAGE -->
<section class="<?php echo esc_attr( $section_class ); ?>" <?php polo_render($parallax_bg_style); ?>>
	<div class="container">
					...
					<div class="col-md-6">
						<div class="text-left">
							<?php if ( isset( $page_title ) && ! empty( $page_title ) ) { ?>
								<h1 class="text-medium"><?php polo_render($page_title); ?></h1>
							<?php } ?>
							<?php if ( isset( $page_description ) && ! empty( $page_description ) ) { ?>
								<p class="lead"><?php polo_render($page_description); ?></p>
							<?php } ?>
